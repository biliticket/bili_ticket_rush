...
impl CTokenGenerator {
    ...
    pub fn generate_ctoken(&mut self, is_create_v2: bool) -> String {
        ...
        self.screen_height = rand::rng().random_range(1000..=3000); // 屏幕高度: 用于条件判断
        self.screen_avail_width = rand::rng().random_range(1..=100); // 屏幕可用宽度: 用于条件判断
        ...
        if is_create_v2 {
            ...
            self.touch_event = rand::rng().random_range(3..=10);
        }
